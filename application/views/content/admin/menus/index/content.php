...
<?php
    if ($menus = Menu::all (array ('include' => array ('subs'), 'order' => 'id ASC', 'limit' => 8, 'conditions' => array ('menu_id = 0')))) {
      ...
      <?php } ?>
            ...
            <a data-url='<?php echo base_url ('admin', 'menus', 'link_menu', $menu->id);?>' class='link_menu icon-link' data-val='<?php echo $menu->link;?>'></a>
          </div>
      ...
      <?php if ($menu->subs) {
              ...
              <?php }?>
                  ...
                  <span>
                    ...
                    <a data-url='<?php echo base_url ('admin', 'menus', 'link_menu', $sub->id);?>' class='link_menu icon-link' data-val='<?php echo $sub->link;?>'></a>
                  </span>
                </div>
        <?php }
            } ?>
